...
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 7), new ItemStack(Items.potion_blue, 1, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Items.potion_blue, 1), new ItemStack(Item.emerald, 13, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 13), new ItemStack(Items.potion_blue, 1, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Items.potion_blue, 1), new ItemStack(Item.emerald, 14, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 14), new ItemStack(Items.potion_blue, 1, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Items.potion_blue, 1), new ItemStack(Item.emerald, 15, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 15), new ItemStack(Items.potion_red, 1, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Items.potion_red, 1), new ItemStack(Item.emerald, 7, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 6), new ItemStack(Items.potion_red, 1, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Items.potion_red, 1), new ItemStack(Item.emerald, 6, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 8), new ItemStack(Items.potion_red, 1, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Items.potion_red, 1), new ItemStack(Item.emerald, 8, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 7), new ItemStack(Items.potion_green, 1, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Items.potion_green, 1), new ItemStack(Item.emerald, 7, 0)));
recipeList.add(new MerchantRecipe(new ItemStack(Item.emerald, 8), new ItemStack(Items.potion_green, 1, 0)));
